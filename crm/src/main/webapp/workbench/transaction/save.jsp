...
<script type="text/javascript">
	...
	$(function () {
		...
		$("#bundBtn").click(function () {
			...
			$("#activityName").val($("#"+activityId).html());
			...
			if (event.keyCode == 13){
				...
				$.ajax({
					...
					success:function (data) {
						...
						$.each(data, function (i, n) {
							html += '<tr>';
							html += '<td><input value="'+n.id+'" type="radio" name="contacts"/></td>';
		...
		$("#contactsBtn").click(function () {
			...
			$("#contactsName").val($("#"+contactsId).html());
...
<body>
	...
	<form action="workbench/transaction/save.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control time1" readonly style="cursor: pointer" name="expectedDate" id="create-expectedDate">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control time2" style="cursor: pointer" readonly id="create-nextContactTime" name="nextContactTime">
			</div>
		</div>

...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.success) {
                            ...
                            html += '<a class="myHref" href="javascript:void(0);"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #3e8f3e;"></span></a>';
                            html += '&nbsp;&nbsp;&nbsp;&nbsp;';
            ...
            $("#bundBtn").click(function(){
                ...
                if ($("input[name=xz]:checked").length == 0){
                    ...
                    $.ajax({
                        url:"workbench/clue/saveClueActivity.do?" + param,
                        type:"get",
                        dataType:"json",
            ...
            $("#removeBtn").click(function () {
                ...
                if (window.confirm("您确定删除该线索吗?")){
                    ...
                    $.ajax({
                        ...
                        success:function (flag) {
                            if(flag){
                                window.location = "workbench/clue/index.jsp";
                            }else {
                                alert("线索删除失败")
                            }
                        }
        ...
        function getRemarkList() {
            $.ajax({
                url: "workbench/clue/getClueRemark.do",
                data: {"clueId": "${clue.id}"},
                type: "get",
                dataType: "json",
                success: function (data) {
